...
double ptscDriver::PoseData::get_position(const std::string& position, int dimension)
{
...
std::vector<double> ptscDriver::PoseData::get_calibrated_position_vector(const std::string& position)
{
...
//bool ptscDriver::PoseData::hands_up()
//{
...
//void ptscDriver::PoseData::calibrate() {
...
//void ptscDriver::PoseData::calculate_scale()
//{
...
//}
//
//void ptscDriver::PoseData::calculate_depth()
//{
...
//}
//
//void ptscDriver::PoseData::clear_calibration_data()
//{
