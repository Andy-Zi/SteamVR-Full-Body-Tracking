...
namespace ChartWin
{
    ...
    public class Graph3D : Chart
    {
        ...
        public readonly static List<(List<string>, Color)> PossibleBodies = new()
        {
            ...
            new(new() { "RIGHT_HIP", "RIGHT_KNEE", "RIGHT_ANKLE", "RIGHT_FOOT_INDEX" }, Color.Yellow),
            new(new() { "LEFT_HIP", "LEFT_KNEE", "LEFT_ANKLE", "LEFT_FOOT_INDEX" }, Color.Violet),
