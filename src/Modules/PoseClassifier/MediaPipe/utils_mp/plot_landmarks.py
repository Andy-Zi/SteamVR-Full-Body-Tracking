...
POSE_CONNECTIONS = frozenset([(0, 1), (0, 2), (1, 3), (2, 4), (5, 6),
...
def plot_results_on_image(
    image: np.ndarray, results:Positions):
    ...
    landmark_drawing_spec: Union[DrawingSpec,
                                 Mapping[int, DrawingSpec]] = mp_drawing_styles.get_default_pose_landmarks_style()
